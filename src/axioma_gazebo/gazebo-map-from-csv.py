...
# URL: https://github.com/DaniGarciaLopez/ros2_axioma
...
for filename in filenames: #Iterate through all csv filenames
    ...
    description = etree.SubElement(model, "description").text='Map generated automatically from a csv file. More info: https://github.com/DaniGarciaLopez/ros2_axioma'
